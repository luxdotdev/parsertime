...
export async function LandingPage() {
  ...
  const primaryFeatures: PrimaryFeature[] = [
    ...
    {
      name: t("primaryFeatures.advancedStatistics.name"),
      description: t("primaryFeatures.advancedStatistics.description"),
      href: "/about",
  ...
  const secondaryFeatures = [
    ...
    {
      name: t("secondaryFeatures.userProfiles.name"),
      description: t("secondaryFeatures.userProfiles.description"),
    ...
    {
      name: t("secondaryFeatures.fastReliable.name"),
      description: t("secondaryFeatures.fastReliable.description"),
      icon: CloudIcon,
    },
    {
    ...
    <div className="bg-white dark:bg-black">
      <main>
        ...
        <div className="relative isolate overflow-hidden bg-white dark:bg-black">
          ...
          >
            <div
              className="aspect-[1108/632] w-[69.25rem] bg-gradient-to-r from-[oklch(0.92_0.10_88)] to-[oklch(0.65_0.17_72)] opacity-20"
              style={{
                clipPath:
        ...
        <div className="relative isolate mt-24 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
          ...
          >
            <div
              className="aspect-[1108/632] w-[69.25rem] flex-none bg-gradient-to-r from-[oklch(0.92_0.10_88)] to-[oklch(0.65_0.17_72)] opacity-20"
              style={{
                clipPath:
                  "polygon(73.6% 51.7%, 91.7% 11.8%, 100% 46.4%, 97.4% 82.2%, 92.5% 84.9%, 75.7% 64%, 55.3% 47.5%, 46.5% 49.4%, 45% 62.9%, 50.3% 87.2%, 21.3% 64.1%, 0.1% 100%, 5.4% 51.1%, 21.4% 63.9%, 58.9% 0.2%, 73.6% 51.7%)",
              }}
