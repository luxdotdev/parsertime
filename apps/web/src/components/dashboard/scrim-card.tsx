...
export function ScrimCard({ scrim, prefetch }: Props) {
  ...
  // Whole-card click-through uses the overlay-link pattern (the title link
  // stretches an ::after over the Card) instead of wrapping the Card in a
  // Link: the card contains more links (edit, scouting report), and nested
  // <a> elements are invalid HTML that breaks hydration.
  return (
    <Card
      data-size="sm"
