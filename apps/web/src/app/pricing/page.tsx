...
// Static shell: the font-scoped page frame prerenders and the locale- and
// auth-derived content streams into ONE boundary whose fallback mirrors the
// full pricing page layout — so navigation shows a single, stable skeleton
// instead of a cascade of different loading states.
...
// Mirrors the loaded page's section rhythm (hero, tier cards, comparison
// table, logo cloud, testimonial, FAQ, CTA, footer) with matching paddings so
        ...
        <section className="relative py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <Skeleton className="mx-auto h-10 w-80 max-w-full sm:h-[3.75rem] sm:w-[32rem]" />
      ...
      <footer className="relative">
        <div className="mx-auto max-w-7xl px-6 pt-4 pb-8 lg:px-8">
          <div className="border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between dark:border-white/10">
            ...
            <Skeleton className="mt-8 h-3 w-48 md:order-1 md:mt-0" />
          </div>
        </div>
      </footer>
    </>
