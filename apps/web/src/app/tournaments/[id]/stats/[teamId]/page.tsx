...
export default function TournamentTeamStatsPage(props: {
  ...
  return (
    <Suspense fallback={<TeamStatsPageSkeleton />}>
...
// Mirrors the loaded page frame: team header, tab list, then the overview
// tab's quick stats, roster/activity, and map sections.
function TeamStatsPageSkeleton() {
  return (
    <div className="flex-1 space-y-4 p-4 pt-6 md:p-8">
      <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-4">
