...
// Static shell: the page frame prerenders and all request-derived content
// streams into ONE boundary whose fallback mirrors the loaded profile layout,
// so navigation shows a single stable skeleton that the content replaces in
// place.
...
// Mirrors the loaded profile's pending layout (header, tab bar, stat ribbon,
// and the overview sections) so the streamed content replaces this in place.
