  ...
  const sections = [
    {
      ...
      features: [
        ...
        },
        {
          ...
          tiers: {
            [t("tiers.free")]: t("features.createTeams.free"),
            [t("tiers.basic")]: t("features.createTeams.basic"),
            [t("tiers.premium")]: t("features.createTeams.premium"),
          },
          comingSoon: false,
        },
        {
          ...
          tiers: {
            [t("tiers.free")]: t("features.teamMembers.free"),
            [t("tiers.basic")]: t("features.teamMembers.basic"),
            [t("tiers.premium")]: t("features.teamMembers.premium"),
          },
          comingSoon: false,
        },
        {
          name: t("features.earlyAccess"),
          tiers: { [t("tiers.premium")]: true },
          comingSoon: false,
        },
      ],
    },
    {
      ...
      features: [
        ...
        {
          name: t("mapStatistics.mapKillFeeds"),
          tiers: {
            [t("tiers.free")]: true,
            [t("tiers.basic")]: true,
            [t("tiers.premium")]: true,
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          tiers: { [t("tiers.basic")]: true, [t("tiers.premium")]: true },
          comingSoon: false,
        },
        {
