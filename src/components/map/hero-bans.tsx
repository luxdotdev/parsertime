  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="flex gap-1">
        {sortedBans.map((ban) => {
          const teamColor = ban.team === team1Name ? team1Color : team2Color;
          return (
            <div
              key={ban.id}
              className={cn("relative h-12 w-12 overflow-hidden rounded-md")}
            ...
            >
              <Tooltip>
                ...
                <TooltipContent>
                  <p aria-hidden="true">
                    {t("bannedBy", { hero: ban.hero, team: ban.team })}
                  </p>
                </TooltipContent>
              </Tooltip>
              <div
                className="absolute -top-0.5 -right-0.5 flex h-4 w-4 items-center justify-center rounded-sm text-xs font-bold text-white [text-shadow:0_0_2px_rgba(0,0,0,0.4)]"
