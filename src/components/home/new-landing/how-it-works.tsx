    ...
    >
      <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        >
          ...
          <div className="relative mt-8 border-l-2 border-dashed border-gray-200 dark:border-white/10">
            {steps.map((step) => (
              <div
                key={step.id}
        ...
        >
          <div className="relative w-full overflow-hidden rounded-2xl border border-gray-200 bg-white/50 p-2 shadow-2xl backdrop-blur-xl dark:border-white/10 dark:bg-white/5">
