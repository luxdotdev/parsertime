        ...
        <CardFooter>
          <p className="text-sm text-muted-foreground">
            {timeframe !== "custom" && timeframe !== "all-time" ? (
              ...
              <>
                {t.rich("bestPerformance.footer2", {
                  timeframe1:
                    timeframe === "custom"
                      ? customScrims.length
                      : timeframe === "all-time" && scrims["all-time"].length,
        ...
        <CardFooter>
          <p className="text-sm text-muted-foreground">
            {timeframe !== "custom" && timeframe !== "all-time" ? (
              ...
              <>
                {t.rich("heroesDiedToMost.footer2", {
                  timeframe1:
                    timeframe === "custom"
                      ? customScrims.length
                      : timeframe === "all-time" && scrims["all-time"].length,
