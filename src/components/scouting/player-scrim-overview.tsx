...
export function PlayerScrimOverview({ scrimData }: PlayerScrimOverviewProps) {
  ...
  const tMethod = useTranslations(
    "scoutingPage.player.analytics.scrimOverview.methodology"
  );
        ...
        <CardContent>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <MetricCard
              ...
              sentiment={
                advancedMetrics.mvpScore > 0
                  ? "positive"
                  : advancedMetrics.mvpScore < -5
                    ? "negative"
                    : "neutral"
              }
            ...
            <MetricCard
              ...
              subtitle={t("firstPicks", {
                count: advancedMetrics.firstPickCount,
              })}
              sentiment={
                advancedMetrics.firstPickPercentage > 25
                  ? "positive"
                  : "neutral"
              }
            ...
            <MetricCard
              ...
              subtitle={t("firstDeaths", {
                count: advancedMetrics.firstDeathCount,
              })}
              sentiment={
                advancedMetrics.firstDeathPercentage > 30
                  ? "negative"
                  : advancedMetrics.firstDeathPercentage < 15
                    ? "positive"
                    : "neutral"
              }
            ...
            <MetricCard
              ...
              sentiment={
                advancedMetrics.fightReversalPercentage > 15
                  ? "positive"
                  : "neutral"
              }
            ...
            <MetricCard
              ...
              sentiment={
                advancedMetrics.killsPerUltimate > 1.5 ? "positive" : "neutral"
              }
            ...
            <MetricCard
              ...
              subtitle={t("outOf100")}
              sentiment={
                advancedMetrics.consistencyScore > 75
                  ? "positive"
