...
import { computePlayerTargets } from "@/lib/query-builder/compute/player-targets";
  ...
  try {
    switch (spec.dataset) {
      ...
      case "player_map_performance":
        ...
        break;
      case "player_impact":
        computedRows = await computePlayerImpact(spec.teamId, ctx.scrimIds);
        break;
      case "player_trend":
      ...
      case "player_outlier":
        ...
        break;
      case "player_target":
        computedRows = await computePlayerTargets(spec.teamId, ctx.scrimIds);
        break;
