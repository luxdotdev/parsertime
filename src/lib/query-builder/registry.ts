...
export const DATASET_REGISTRY: Record<DatasetId, DatasetDef> = {
  ...
  map_result: {
    ...
    dimensions: [
      { id: "result", label: "result", table: "MapResult", column: "result", source: "base" },
      { id: "map", label: "map", table: "MapResult", column: "map", source: "base" },
      { id: "map_type", label: "map type", table: "MapResult", column: "map_type", source: "base" },
      { id: "opponent", label: "opponent", table: "MapResult", column: "opponent", source: "base" },
      { id: "scrim", label: "scrim", table: "MapResult", column: "scrim", source: "base" },
    ],
    filters: [
      {
        id: "map_type",
  ...
  ult_economy: {
    ...
    dimensions: [
      { id: "advantage", label: "ult advantage", table: "UltEconomy", column: "advantage", source: "base" },
      { id: "advantage_bucket", label: "advantage bucket", table: "UltEconomy", column: "advantage_bucket", source: "base" },
      { id: "result", label: "result", table: "UltEconomy", column: "result", source: "base" },
      { id: "map_type", label: "map type", table: "UltEconomy", column: "map_type", source: "base" },
      { id: "scrim", label: "scrim", table: "UltEconomy", column: "scrim", source: "base" },
    ],
    filters: [
      {
        id: "advantage_bucket",
  ...
  duel: {
    ...
    dimensions: [
      { id: "our_hero", label: "our hero", table: "Duel", column: "our_hero", source: "base" },
      { id: "enemy_hero", label: "enemy hero", table: "Duel", column: "enemy_hero", source: "base" },
      { id: "map_type", label: "map type", table: "Duel", column: "map_type", source: "base" },
      { id: "scrim", label: "scrim", table: "Duel", column: "scrim", source: "base" },
    ],
    filters: [
      {
        id: "map_type",
